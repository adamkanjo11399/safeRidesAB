...
var Ze = defineComponent({ name: "Combobox", emits: { "update:modelValue": (a5) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], nullable: true, default: null }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, nullable: { type: Boolean, default: false }, multiple: { type: [Boolean], default: false }, immediate: { type: [Boolean], default: false }, virtual: { type: Object, default: null } }, inheritAttrs: false, setup(a5, { slots: I3, attrs: r3, emit: O5 }) {
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [...l4 != null && v4.value != null ? e2({ [l4]: v4.value }).map(([U3, ue4]) => h(f, E2({ features: s3.Hidden, key: U3, as: "input", type: "hidden", hidden: true, readOnly: true, form: s7, name: U3, value: ue4 }))) : [], A({ theirProps: { ...r3, ...T2(f4, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"]) }, ourProps: {}, slot: y4, slots: I3, attrs: r3, name: "Combobox" })]);
  };
} });
...
var lt = defineComponent({ name: "ComboboxOptions", props: { as: { type: [Object, String], default: "ul" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, hold: { type: [Boolean], default: false } }, setup(a5, { attrs: I3, slots: r3, expose: O5 }) {
...
var at = defineComponent({ name: "ComboboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, order: { type: [Number], default: null } }, setup(a5, { slots: I3, attrs: r3, expose: O5 }) {
...
var Ge2 = defineComponent({ name: "PopoverButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-popover-button-${t()}` } }, inheritAttrs: false, setup(P2, { attrs: b3, slots: p3, expose: h3 }) {
...
export {
  ...
  N6 as PortalGroup,
  ge3 as RadioGroup,
  ke2 as RadioGroupDescription,
  Oe as RadioGroupLabel,
  he as RadioGroupOption,
  ie3 as Switch,
  ue3 as SwitchDescription,
  oe as SwitchGroup,
  ae2 as SwitchLabel,
  xe as Tab,
  me2 as TabGroup,
