...
function element2(node, schema) {
  ...
  if (node.properties) {
    for (prop in node.properties) {
      if (prop !== "children" && own5.call(node.properties, prop)) {
...
function patch2(from, to) {
  const position3 = from.position;
  if (position3 && position3.start && position3.end) {
    ok(typeof position3.start.offset === "number");
    ok(typeof position3.end.offset === "number");
...
function resetTokenizer(state, point3) {
  setPoint(state, point3);
...
function setPoint(state, point3) {
  if (point3 && point3.offset !== void 0) {
    const location2 = {
      startLine: point3.line,
      startCol: point3.column,
      startOffset: point3.offset,
      endLine: -1,
      endCol: -1,
      endOffset: -1
    };
    state.parser.tokenizer.preprocessor.lineStartPos = -point3.column + 1;
    state.parser.tokenizer.preprocessor.droppedBufferSize = point3.offset;
    state.parser.tokenizer.preprocessor.line = point3.line;
...
//# sourceMappingURL=hast-util-raw.js.map
