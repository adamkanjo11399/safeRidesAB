...
// node_modules/node-emoji/node_modules/@sindresorhus/is/dist/index.js
var require_dist = __commonJS({
  "node_modules/node-emoji/node_modules/@sindresorhus/is/dist/index.js"(exports, module) {
    "use strict";
...
var emojify = (input, { fallback, format = (name) => name } = {}) => {
  ...
  import_is.default.assert.string(input);
  import_is.default.assert.any([import_is.default.default.undefined, import_is.default.default.function_], fallbackFunction);
  import_is.default.assert.function_(format);
...
var which = (emoji, { markdown = false } = {}) => {
  import_is9.assert.string(emoji);
  import_is9.assert.boolean(markdown);
...
var unemojify = (input) => {
  import_is8.assert.string(input);
  const characters = input.match(charRegexMatcher);
  if (characters === null) {
    return input;
  }
